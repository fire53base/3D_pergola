...
public class ServerInit : MonoBehaviour 
{
	...
	
	{
		...
		routingManager.AddRoute(new Route(Route.Type.POST, "/pergola", "DB_script.data_base_linking_general"));//data_base_linking_pergola
                                                                                                               //routingManager.AddRoute(new Route(Route.Type.POST, "/architect/pergola", "DB_script.data_base_linking_general"));//data_base_linking_pergola_architect
                                                                                                               //routingManager.AddRoute(new Route(Route.Type.GET, "/louver_points", "DB_script.data_base_linking_points"));
        routingManager.AddRoute(new Route(Route.Type.POST, "/louver", "DB_script.data_base_linking_general"));

		routingManager.AddRoute(new Route(Route.Type.POST, "/architect/pergola", "DB_script.data_base_linking_general"));
		//routingManager.AddRoute(new Route(Route.Type.POST, "/color/{objname}", "MaterialInvoke.SetColor"));
		//routingManager.AddRoute(new Route(Route.Type.POST, "/pergola", "DataBase.receiveImage"4));
